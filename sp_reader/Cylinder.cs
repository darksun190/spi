...
namespace SPInterface
{
    public class Cylinder : Element
    {
        ...
        new public readonly double height;
        ...
        public Cylinder(Element parent)
        {
            if (!(parent.geoType.Equals("Cylinder") || parent.geoType.Equals("Circle")))
            {
            ...
            double[] zero_point = new[] { pos[0], pos[1], pos[2] };
